...
bool ShaderCopyImage::BeginDraw(const std::shared_ptr<prosper::ICommandBuffer> &cmdBuffer,Pipeline pipelineIdx) {return ShaderGraphics::BeginDraw(cmdBuffer,umath::to_integral(pipelineIdx));}
