...
prosper::util::PreparedCommand::Argument::Argument(Argument &&other)
{
	operator=(std::move(other));
}
prosper::util::PreparedCommand::Argument::~Argument()
{
	Clear();
}
prosper::util::PreparedCommand::Argument::Argument(const std::string &dynamicValue)
	: Argument{}
{
...
prosper::util::PreparedCommand::PreparedCommand(PreparedCommandFunction &&function,std::vector<Argument> &&args)
...
{}
void prosper::util::PreparedCommandBuffer::PushCommand(PreparedCommandFunction &&cmd,std::vector<PreparedCommand::Argument> &&args)
{
	commands.emplace_back(std::move(cmd),std::move(args));
}
